...
const faqs = [
  { q: "How do I change my subscription plan?", a: "You can upgrade or cancel your subscription at any time by navigating to the Billing section in your dashboard. If you upgrade mid-cycle, the pricing will be prorated automatically." },
  { q: "When do payouts reach my bank account?", a: "Payments processed through the ArtistOS booking link are settled directly to your registered bank account via Razorpay within T+2 (two business days) automatically." },
  { q: "Can I use my own domain name?", a: "Yes, custom domain mapping is available for Custom and White-label plans. Please contact our support team to set this up." },
];
...
export default function HelpSupportPage() {
  return (
    <article className="prose prose-slate max-w-none prose-headings:font-semibold prose-headings:tracking-tight prose-a:text-[#7c3aed] hover:prose-a:text-[#6d28d9]">
      <h1 className="text-3xl font-bold tracking-tight text-[#15172e] sm:text-4xl mb-4">Help &amp; Support</h1>
      <p className="text-sm text-[#666a82] mb-10">Everything you need to set up, manage, and grow your beauty business on ArtistOS.</p>
      ...
      <div className="not-prose grid gap-6 sm:grid-cols-2 mb-16">
        <div className="group relative overflow-hidden rounded-3xl border border-[#edf0fa] bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-[#0284c7]/10">
          ...
          <div className="relative">
            <div className="mb-6 flex size-14 items-center justify-center rounded-2xl bg-[#e0f2fe] text-[#0284c7] shadow-inner"><MessageCircle className="size-7" /></div>
            <h3 className="text-xl font-bold text-[#15172e] mb-3">WhatsApp Support</h3>
            <p className="text-[#666a82] mb-6 leading-relaxed">Priority members can chat directly with our support team on WhatsApp for instant resolutions.</p>
        ...
        <div className="group relative overflow-hidden rounded-3xl border border-[#edf0fa] bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-[#7c3aed]/10">
          ...
          <div className="relative">
            <div className="mb-6 flex size-14 items-center justify-center rounded-2xl bg-[#f3e8ff] text-[#7c3aed] shadow-inner"><Mail className="size-7" /></div>
            <h3 className="text-xl font-bold text-[#15172e] mb-3">Email Support</h3>
            <p className="text-[#666a82] mb-6 leading-relaxed">Drop us an email anytime. We aim to respond to all technical and billing queries within 24 hours.</p>
            <a href="mailto:artistoscrm@gmail.com" className="inline-flex h-10 items-center justify-center rounded-full bg-[#7c3aed] px-6 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[#6d28d9]">artistoscrm@gmail.com</a>
          </div>
        </div>
      </div>
